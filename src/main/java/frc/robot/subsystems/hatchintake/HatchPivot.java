...
public class HatchPivot extends Subsystem {
    ...
    private HatchPivot() {
        ...
        hatchPivotPID.setP(RobotMap.HATCH_PIVOT_PIDF[0]);
        hatchPivotPID.setI(RobotMap.HATCH_PIVOT_PIDF[1]);
        hatchPivotPID.setD(RobotMap.HATCH_PIVOT_PIDF[2]);
        hatchPivotPID.setFF(RobotMap.HATCH_PIVOT_PIDF[3]);
        hatchPivotPID.setIZone(0.0);
        hatchPivotPID.setOutputRange(RobotMap.HATCH_PIVOT_PID_MIN_OUTPUT, RobotMap.HATCH_PIVOT_PID_MAX_OUTPUT);

        limitSwitch = new DigitalInput(RobotMap.HATCH_PIVOT_LIMIT_SWITCH_ID);
        lastLimit = true;
        ...
        switch(state) {
            ...
            case PID:
                if(currentPIDSetpoint == -1257) {
                    ...
                    if(error < RobotMap.HATCH_PIVOT_PID_TOLERANCE) {
                        state = State.MANUAL;
                    }
                }   
            break;
    ...
    public void setSpeed(double value) {
        speed = value * RobotMap.HATCH_PIVOT_MAX_SPEED;
    ...
    public void raisePivot() {
        setPIDPosition(RobotMap.HATCH_PIVOT_PID_RAISED);
    }

    public void lowerPivot() {
        setPIDPosition(RobotMap.HATCH_PIVOT_PID_LOWERED);
    }
    ...
    public void setConstantTuning() {
        SmartDashboard.putNumber("Hatch Max Speed", RobotMap.HATCH_PIVOT_MAX_SPEED);

        SmartDashboard.putNumber("Hatch P", RobotMap.HATCH_PIVOT_PIDF[0]);
        SmartDashboard.putNumber("Hatch I", RobotMap.HATCH_PIVOT_PIDF[1]);
        SmartDashboard.putNumber("Hatch D", RobotMap.HATCH_PIVOT_PIDF[2]);
        SmartDashboard.putNumber("Hatch F", RobotMap.HATCH_PIVOT_PIDF[3]);
    }

    public void getConstantTuning() {
        RobotMap.HATCH_PIVOT_MAX_SPEED = SmartDashboard.getNumber("Hatch Max Speed", RobotMap.HATCH_PIVOT_MAX_SPEED);
        
        if(RobotMap.HATCH_PIVOT_PIDF[0] != SmartDashboard.getNumber("Hatch P", RobotMap.HATCH_PIVOT_PIDF[0])) {
            RobotMap.HATCH_PIVOT_PIDF[0] = SmartDashboard.getNumber("Hatch P", RobotMap.HATCH_PIVOT_PIDF[0]);
            hatchPivotPID.setP(RobotMap.HATCH_PIVOT_PIDF[0]);
        }
        if(RobotMap.HATCH_PIVOT_PIDF[1] != SmartDashboard.getNumber("Hatch I", RobotMap.HATCH_PIVOT_PIDF[1])) {
            RobotMap.HATCH_PIVOT_PIDF[1] = SmartDashboard.getNumber("Hatch I", RobotMap.HATCH_PIVOT_PIDF[1]);
            hatchPivotPID.setP(RobotMap.HATCH_PIVOT_PIDF[1]);
        }
        if(RobotMap.HATCH_PIVOT_PIDF[2] != SmartDashboard.getNumber("Hatch D", RobotMap.HATCH_PIVOT_PIDF[2])) {
            RobotMap.HATCH_PIVOT_PIDF[2] = SmartDashboard.getNumber("Hatch D", RobotMap.HATCH_PIVOT_PIDF[2]);
            hatchPivotPID.setP(RobotMap.HATCH_PIVOT_PIDF[2]);
        }
        if(RobotMap.HATCH_PIVOT_PIDF[3] != SmartDashboard.getNumber("Hatch F", RobotMap.HATCH_PIVOT_PIDF[3])) {
            RobotMap.HATCH_PIVOT_PIDF[3] = SmartDashboard.getNumber("Hatch F", RobotMap.HATCH_PIVOT_PIDF[3]);
            hatchPivotPID.setP(RobotMap.HATCH_PIVOT_PIDF[3]);
        }
    }
